---
name: greg-coding
description: Instrucciones de contexto para tareas de implementación de código dentro de una tarea greg multi-agente. Cubre git workflow, checklist pre-done, estándares de calidad y protocolo de colaboración entre agentes. Úsalo cuando estés en un worktree aislado de greg y necesites las reglas de juego del equipo.
---
